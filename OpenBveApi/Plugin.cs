...
namespace OpenBveApi {
	...
	public interface IPlugin10 : IPlugin {
		...
		General.Priority CanLoadTexture(Path.PathReference path, Encoding encoding, object data);
		...
		General.Result LoadTexture(Path.PathReference path, Encoding encoding, object data, out Texture.TextureData texture);
		...
		General.Priority CanLoadObject(Path.PathReference path, Encoding encoding, object data);
		...
		/// <returns>The success of the operation.</returns>
		General.Result LoadObject(Path.PathReference path, Encoding encoding, object data, out Geometry.GenericObject obj);
		...
		General.Priority CanLoadSound(Path.PathReference path, Encoding encoding, object data);
		...
		/// <returns>The success of the operation.</returns>
		General.Result LoadSound(Path.PathReference path, Encoding encoding, object data, out Sound.SoundData sound);
		...
		General.Priority CanLoadRoute(Path.PathReference path, Encoding encoding, object data);
		...
		/// <returns>The success of the operation.</returns>
		General.Result LoadRoute(Path.PathReference path, Encoding encoding, object data, out Route.RouteData route);
		...
		/// <returns>The success of the operation.</returns>
		General.Result QueryPluginData(int contentType, out object contentData);
		...
		/// <returns>The success of the operation.</returns>
		General.Result SubmitPluginData(int contentType, object contentData);
