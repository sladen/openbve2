...
namespace OpenBveApi {
	...
	public interface IPlugin10 : IPlugin {
		...
		General.Priority CanLoadTexture(Path.PathType type, string path, Encoding encoding, object data);
		...
		General.Priority CanLoadObject(Path.PathType type, string path, Encoding encoding, object data);
		...
		/// <returns>The success of the operation.</returns>
		General.Result LoadObject(Path.PathType type, string path, Encoding encoding, object data, out Geometry.GenericObject obj);
		...
		General.Priority CanLoadSound(Path.PathType type, string path, Encoding encoding, object data);
		...
		/// <returns>The success of the operation.</returns>
		General.Result LoadSound(Path.PathType type, string path, Encoding encoding, object data, out Sound.SoundData sound);
